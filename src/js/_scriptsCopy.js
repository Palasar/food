...
//1) вынести функции открытия и закрытия модального окна за пределы модульной функции
//2) экспортировать функции открытия и закрытия модального окна
     //из modal v forms
//3) передать нужные аргуьенты  в модульне функции
//4) подставить нужные аргументы в соответствующих функциях в главном js файле
//5) подсьавить нужные аргументы в modal.js в функции открытия и закрытия модального окна а
//6) если нужно предотвратить вызов функции открытия и закрытия модального окна
  // сразу обернуть ее в стрелочную функцию () => openModal(modalSelector)


//7) передать в качества аргумента modalTimerId в функцию щткрытия модального окна
//8) написать условие в функции открытия модального окна которое будет проверять 
  // получен ли id в modalTimerId
//9) задать тртим аргументом modalTimerId в модульную функцию
//10) зфдфть вторыь аргументом в фукции открытия модального окна modalTimerId
//11) перенести присвоение id modalTimerId в script.js
